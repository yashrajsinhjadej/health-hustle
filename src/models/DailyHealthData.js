...
// Important: Use existing model if already compiled to avoid OverwriteModelError
module.exports =
  mongoose.models.DailyHealthData ||
  mongoose.model('DailyHealthData', dailyHealthDataSchema);
